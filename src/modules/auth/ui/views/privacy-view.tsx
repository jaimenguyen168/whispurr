  ...
  return (
    <SafeAreaView className="flex-1 bg-app">
      <View className="flex-row items-center justify-between px-5 py-4 border-b border-soft">
        ...
        <Text className="text-lg font-bold text-main">Privacy Policy</Text>
      ...
      >
        ...
        <View className="bg-primary-50 border border-primary-200 rounded-2xl px-4 py-4 mb-8 flex-row items-start gap-3">
          ...
          <View className="flex-1">
            <Text className="text-primary-700 font-bold text-sm mb-1">We Cannot Read Your Messages</Text>
        ...
        <View className="gap-6">
          <View>
            <Text className="font-bold text-base text-main mb-2">1. What We Collect</Text>
          ...
          <View>
            <Text className="font-bold text-base text-main mb-2">2. What We Cannot Access</Text>
            <Text className="text-sm text-secondary leading-6">
          ...
          <View>
            <Text className="font-bold text-base text-main mb-2">3. How We Use Your Data</Text>
            <Text className="text-sm text-secondary leading-6">
          ...
          <View>
            <Text className="font-bold text-base text-main mb-2">4. Push Notifications</Text>
            <Text className="text-sm text-secondary leading-6">
          ...
          <View>
            <Text className="font-bold text-base text-main mb-2">5. Your Rights</Text>
            <Text className="text-sm text-secondary leading-6">
          ...
          <View>
            <Text className="font-bold text-base text-main mb-2">6. Contact</Text>
            <Text className="text-sm text-secondary leading-6">privacy@whispurr.app</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
