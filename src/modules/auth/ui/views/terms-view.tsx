  ...
  return (
    <SafeAreaView className="flex-1 bg-app">
      <View className="flex-row items-center justify-between px-5 py-4 border-b border-soft">
        ...
        <Text className="text-xl font-bold text-main">Terms of Service</Text>
      ...
      >
        ...
        <View className="bg-primary-50 border border-primary-200 rounded-2xl px-4 py-4 mb-8 flex-row items-start gap-3">
          ...
          <View className="flex-1">
            <Text className="text-primary-700 font-bold text-base mb-1">End-to-End Encrypted</Text>
        ...
        <View className="gap-6">
          <View>
            <Text className="font-bold text-lg text-main mb-2">1. Acceptance</Text>
          ...
          <View>
            <Text className="font-bold text-lg text-main mb-2">2. Eligibility</Text>
            <Text className="text-base text-secondary leading-6">
          ...
          <View>
            <Text className="font-bold text-lg text-main mb-2">3. Use of Service</Text>
            <Text className="text-base text-secondary leading-6">
          ...
          <View>
            <Text className="font-bold text-lg text-main mb-2">4. Encryption & Privacy</Text>
            <Text className="text-base text-secondary leading-6">
          ...
          <View>
            <Text className="font-bold text-lg text-main mb-2">5. Account Responsibility</Text>
            <Text className="text-base text-secondary leading-6">
          ...
          <View>
            <Text className="font-bold text-lg text-main mb-2">6. Intellectual Property</Text>
            <Text className="text-base text-secondary leading-6">
          ...
          <View>
            <Text className="font-bold text-lg text-main mb-2">7. Disclaimer of Warranties</Text>
            <Text className="text-base text-secondary leading-6">
          ...
          <View>
            <Text className="font-bold text-lg text-main mb-2">8. Limitation of Liability</Text>
            <Text className="text-base text-secondary leading-6">
          ...
          <View>
            <Text className="font-bold text-lg text-main mb-2">9. Termination</Text>
            <Text className="text-base text-secondary leading-6">
          ...
          <View>
            <Text className="font-bold text-lg text-main mb-2">10. Changes to Terms</Text>
            <Text className="text-base text-secondary leading-6">
          ...
          <View>
            <Text className="font-bold text-lg text-main mb-2">11. Contact</Text>
            <Text className="text-base text-secondary leading-6">support@whispurr.app</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
